...
/// BurnSharesRequest : Fields common to every signed vault action. They appear alongside each endpoint's action-specific parameters in the same request object.
...
impl BurnSharesRequest {
    ...
    pub fn new(nonce: i32, request_id: models::VaultRequestId, share_price: bigdecimal::BigDecimal, signature: String, signature_expiry_sec: i32, signer: String, subaccount_id: i32, withdraw_hash: String) -> BurnSharesRequest {
        BurnSharesRequest {
            nonce,
            request_id,
            share_price,
